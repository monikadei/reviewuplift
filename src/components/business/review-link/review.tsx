...
export default function ReviewPage() {
  ...
  const handleLeaveReview = async () => {
    ...
    if (!isReviewGatingEnabled || rating >= 4) {
      const reviewUrl = rating >= 4 && googleReviewLink ? googleReviewLink : reviewLinkUrl
        ...
        <div className="w-full md:w-1/2 bg-gradient-to-b from-orange-50 to-orange-100 relative overflow-hidden">
          ...
          <div className="relative h-full flex flex-col justify-center items-center p-8">
            ...
            <div className="mt-8 text-center max-w-md">
              ...
              <p className="text-lg text-gray-600">{welcomeText || "Share your experience and help us improve"}</p>
            </div>
          </div>
        </div>
            ...
            {submitted ? (
              <div className="text-center space-y-4">
                <div className="p-4 rounded-lg bg-gray-50 border border-gray-200">
                  <p className="text-gray-700 font-medium">{submissionMessage}</p>
                </div>
                <button
                  onClick={resetForm}
                  ...
                  <div className="mb-6 space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        required
                      />
                      {formErrors.name && <p className="mt-1 text-xs text-red-500">This field is required</p>}
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        required
                      />
                      {formErrors.phone && <p className="mt-1 text-xs text-red-500">This field is required</p>}
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        required
                      />
                      {formErrors.email && <p className="mt-1 text-xs text-red-500">This field is required</p>}
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        required
                      />
                      {formErrors.branchname && <p className="mt-1 text-xs text-red-500">This field is required</p>}
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        required
                      ></textarea>
                      {formErrors.review && <p className="mt-1 text-xs text-red-500">This field is required</p>}
                    </div>
                  </div>
                )}
